...
public class Exam01 {
    ...
    static void init() throws Exception {
        ...
        String uerLanguage = System.getProperty("user.language");
    ...
    public static void main(String[] args)throws Exception {
        ...
        // 이유는?? 다양한 언어로 출력하기 위함이다.
        // 즉, 다국어를 제공할 수 있도록 프로그래밍 하는 것을
        // "국제화 지원(i18n;Internationalization)" 이라고 얘기한다.
        ...
        //  => 이 프로퍼티 파일에 저장된 데이터를 각각의 어어로 바꾸는 것을 지역화라 부른다.
    }
