...
public class Exam04_1 {
    ...
    static class Score{
        ...
        // => 인스턴스를 만들 때 자동 호출된다.
        //    일반 메서드 처럼 나중에 따로 호출할 수 없다.
        // => 만약 개발자가 생성자를 만들지 않으면 컴파일러가 자동으로 생성해 준다.
        //    모든 클래스는 반드시 한 개 이상의 생성자가 있다.
        // => 보통 인스턴스를 만든 후에 인스턴스 변수를 초기화 시키는 용도로 정의한다.
        // => 다음과 파라미터가 없는 생성자가 기본 생성자이다.(default constractor)
        Score(){
    ...
    public static void main(String[] args) {
        ...
        // => 다음과 같이 파라미터 값을 주지 ㅇ낳으면 기본 생성자를 호출하라는 뜻이 된다.
