...
public class Exam01_1 {
    ...
    public static void main(String[] args) {
        ...
        // 이 인스턴스의 주소를 저장하는obj1, obj2, obj3를 "레퍼런스"라 부른다.
        // 인스턴스가 생성될 때 만들어지는 v1, v2과 같은 변수를 "인스턴스 변수"라 부른다
...
//오늘 기억할것
// 클래스를 만들때 static이 붙는게 클래스 스태틱 메소드 안붙는게 인스턴스 메소드라고 부른다(인스턴스 메소드는 반드시 유효한 인스턴스 주소를 넘겨줘서 사용)