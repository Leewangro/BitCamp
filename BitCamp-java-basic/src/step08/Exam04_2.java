...
public class Exam04_2 {
    ...
    // Exma04_1 클래스 조차도 기본 생성자가 자동으로 추가된다.
    ...
    static class Score{
        ...
        Score(String name, int kor , int eng, int math){
            ...
            // => 이렇게 생성자는 새로 만든 인스턴수 변수를 초기화 시키는 일을 한다.
            this.name = name;
            this.kor = kor;
            this.eng = eng;
            this.math = math;
    ...
    public static void main(String[] args) {
        // Score 클래스에는 기본 생성자가 없기 때문에 다음 문자은 컴파일 오류이다.
        //다음 문장은 컴파일 오류
        //Score s0 = new Score(); 
        
        // Score 인스턴스를 만든 후에는 그 생성자의 파라미터 값을 주어야 한다.
        Score s1 = new Score("홍길동",100,90,80);
        Score s2 = new Score("임꺽정",100,60,50);
...
//생성자?
// => 인스턴스(객체)를 생성한 후에 사용하기 전에 유효한 값으로 초기화 시키는 작업을 수행한다.
