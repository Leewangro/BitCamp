...
public class Exam02_3 {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("성적 데이터를 입력하세요(예: 홍길동 10 10 10");
        ...
        s1.compute();// s1에 들어 있는 주소를 compute()에 전달한다.
        
        System.out.print("성적 데이터를 입력하세요(예: 임꺽정 10 10 10");
        ...
        s2.compute(); // s2에 들어 있는 주소를 compute()에 전달한다.
