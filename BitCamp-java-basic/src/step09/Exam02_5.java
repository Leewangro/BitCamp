...
public class Exam02_5 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(c.get(2) + 1); //월(월은 0~11)
        System.out.println(c.get(5)); //일
        System.out.println(c.get(7)); //요일(1~7) (일 월 화 수 목 금 토) 순서로 진행
        ...
        System.out.println(c.get(Calendar.MONTH) + 1); //월(월은 0~11)
        System.out.println(c.get(Calendar.DATE)); //일
        System.out.println(c.get(Calendar.DAY_OF_WEEK)); //요일(1~7) (일 월 화 수 목 금 토) 순서로 진행
