...
CREATE TABLE pms2_team (
	...
	dscrt   TEXT         NULL     COMMENT '팀명', -- 팀명
	max_qty INTEGER      NOT NULL COMMENT '최대인원', -- 최대인원
...
CREATE TABLE pms2_classroom (
	crno INTEGER      NOT NULL COMMENT '번호', -- 번호
...
ALTER TABLE pms2_classroom
	MODIFY COLUMN crno INTEGER NOT NULL AUTO_INCREMENT COMMENT '번호';

-- 작업
CREATE TABLE pms2_task (
	tano INTEGER      NOT NULL COMMENT '번호', -- 번호
...
ALTER TABLE pms2_task
	MODIFY COLUMN tano INTEGER NOT NULL AUTO_INCREMENT COMMENT '번호';
