...
public class Exam07_2 {
    ...
    @RequestMapping(value="m1",produces="text/palin;charset=UTF-8")  
    @ResponseBody
    ...
    public String test() {
        ...
        // 1) ScontextLoaderListener가 관리하는 Spring IoC 컨테이너 얻기
        ...
        for(String name : names) {
            buf.append(name + "=" + rootCtx.getBean(name).getClass().getName() + "\n");
        }
        return buf.toString();
    }
}
