// 요청핸들러의 파라미터 - 파라미터로 받을 수 있는 객체II
...
public class Exam05_2 {
    ...
    // => 파라미터의 타입이 byte,short,int,long,float,double,boolean,char일 경우 (=문자열이 아닐 경우)형변환 할 때 오류가 발생한다.
    @GetMapping(value="m3")  
    @ResponseBody  
    public String m3(
            String name,
    ...
    // => required속성의 값을 false로 지정한다.(생략하면 true이다.)
    @GetMapping(value="m4")  
    @ResponseBody  
    public String m4(
