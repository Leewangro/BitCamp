...
public class Exam01 extends HttpServlet{
    ...
    protected void doGet(
        ...
        // 세션 생성 : getSession() 호출
        // - 우선 웹 브라우저가 보낸 쿠키 중에서 세션 아이디가 있는지 확인한다.
        // - 만약 없다면 새 세션 객체(HttpSession) 생성한 후 그 세션 객체를 리턴한다.
        // - 응답할 때 새로 생성한 세션 객체의 아이디를 웹 브라우저로 쿠키에 담아 전달한다.
        //
        
        // HTTP 응답 프로토콜 예:
        /*HTTP/1.1 200
        Set-Cookie: JSESSIONID=AE9D12C45B5952F63FE622B986F4597A; Path=/bitcamp-web01; HttpOnly
